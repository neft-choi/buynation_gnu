...
<head>
    <meta charset="utf-8">
    <?php
    echo '<meta name="viewport" id="meta_viewport" content="width=device-width,initial-scale=1.0,minimum-scale=1.0,maximum-scale=10,viewport-fit=cover">' . PHP_EOL;
...
<![endif]-->
    <script>
        ...
        // PC 반응형 동기화 함수
        function syncWithPcBreakpoint(callback) {
            var breakpointPc = parseInt(
            ...
            var mediaQuery = window.matchMedia('(min-width: ' + breakpointPc + 'px)');
