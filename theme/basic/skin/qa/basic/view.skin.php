...
<div class="block pc:flex gap-6 pc:px-5 pc:py-12">
    ...
    <!-- 게시물 읽기 시작 { -->
    <article id="bo_v" class="flex-1 min-w-0">
        ...
        <div class="mx-auto w-full max-w-full p-4">
            <header>
                <h2 id="bo_v_title" class="break-all !text-xl ">
                    <?php
            ...
            <section id="bo_v_atc">
                ...
                <!-- 본문 내용 시작 { -->
                <div id="bo_v_con"><?php echo get_view_thumbnail($view['content'], $qaconfig['qa_image_width']); ?>
                </div>
                <!-- } 본문 내용 끝 -->
                    ...
                    <?php if ($update_href || $delete_href) { ?>
                        <li>
                            <button type="button" class="btn_more_opt btn_b01 btn" title="게시판 읽기 옵션"><i
                                    class="fa fa-ellipsis-v" aria-hidden="true"></i><span class="sound_only">게시판 읽기
                                    옵션</span></button>
                            <ul class="more_opt">
                                <?php if ($update_href) { ?>
