...
<section id="sct_sort">
    ...
    <div class="flex justify-end">
        ...
        <div class="relative">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-down-icon lucide-chevron-down pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 text-gray-900 w-4 h-4">
                <path d="m6 9 6 6 6-6" />
            </svg>
        </div>
    </div>
