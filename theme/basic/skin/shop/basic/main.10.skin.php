            ...
            <li class="sct_li">
                <article class="space-y-2">
                    ...
                    <div class="flex w-full gap-1">
                        ...
                        <button type="button" class="btn_wish  sct_btn flex items-center justify-center w-full border border-gray-300 rounded-lg bg-white px-4 py-2" data-it_id="<?= $row['it_id'] ?>" aria-label="위시리스트">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-heart" aria-hidden="true">
                                <path d="M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5" />
                            </svg>
                        </button>
                        <button type="button" class="btn_cart sct_btn flex items-center justify-center w-full border border-gray-300 rounded-lg bg-white px-4 py-2" data-it_id="<?= $row['it_id'] ?>" aria-label="장바구니">
