...
foreach ((array) $list as $row) {
    ...
    if ($i == 1) {
        if ($this->css) {
            ...
            ?>
                <ul class="sct owl-carousel js-shop-slider max-w-[var(--breakpoint-pc)] justify-self-center px-5" data-items-pc="4"
                    data-items-mobile="2.15" data-margin="12" data-stage-padding="12">
                    <?php
        }
    }
    ?>
                ...
                <article class="space-y-2">
                    <div class="relative rounded-lg overflow-hidden">
                        ...
                        <!-- <?php if ($discount_percent > 0) { ?>
                            <span class="badge charity">기부 <?= $discount_percent ?>%</span>
                        <?php } ?> -->
                    ...
                    <div class="flex w-full gap-1">
                        ...
                        <button type="button"
                            class="btn_wish  sct_btn flex items-center justify-center w-full border border-gray-300 rounded-lg bg-white px-4 py-2"
                        ...
                        <button type="button"
                            class="btn_cart sct_btn flex items-center justify-center w-full border border-gray-300 rounded-lg bg-white px-4 py-2"
                    ...
                    <div>
                        <h3 class="font-medium line-clamp-2"><a
                                href="<?= $item_link_href ?>"><?= stripslashes($row['it_name']) ?></a></h3>
