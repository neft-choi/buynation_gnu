...
<div class="btn_fixed_top">
    <a href="./faqmasterlist.php" class="btn btn_05">FAQ 관리</a>
    <a href="./faqform.php?fm_id=<?php echo $fm['fm_id']; ?>" class="btn btn_04">FAQ 상세내용 추가</a>
</div>
            ...
            for ($i = 0; $row = sql_fetch_array($result); $i++) {
                ...
                <tr class="<?php echo $bg; ?>">
                    ...
                    <td class="td_mng td_mng_m">
                        <a href="./faqform.php?w=u&amp;fm_id=<?php echo $row['fm_id']; ?>&amp;fa_id=<?php echo $row['fa_id']; ?>" class="btn btn_04"><span class="sound_only"><?php echo $fa_subject; ?> </span>수정</a>
                        <a href="./faqformupdate.php?w=d&amp;fm_id=<?php echo $row['fm_id']; ?>&amp;fa_id=<?php echo $row['fa_id']; ?>" onclick="return delete_confirm(this);" class="btn btn_05"><span class="sound_only"><?php echo $fa_subject; ?> </span>삭제</a>
                    </td>
                </tr>
                <?php
            }
