...
<section id="anc_cf_url">
    ...
    <div class="local_desc02 local_desc">
        <p>
            게시판과 컨텐츠 페이지에 짧은 URL 을 사용합니다. <a href="https://sir.kr/manual/g5/286" class="btn btn_04" target="_blank" style="margin-left:10px">설정 관련 메뉴얼 보기</a>
    ...
    <div class="server_config_views">
        <?php if ($is_use_apache) { ?>
            <button type="button" data-remodal-target="modal_apache" class="btn btn_04">Apache 설정 코드 보기</button>
        <?php } ?>
        <?php if ($is_use_nginx) { ?>
            <button type="button" data-remodal-target="modal_nginx" class="btn btn_04">Nginx 설정 코드 보기</button>
        <?php } ?>
    </div>
