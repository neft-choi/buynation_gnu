...
<section id="anc_sodr_list">
    ...
    <div class="local_desc02 local_desc">
        <p>
            ...
            |
            주문총액 <strong><?php echo number_format($orderform_policy_order_total); ?></strong>원
        </p>
...
<section id="anc_sodr_pay">
    ...
    $amount['order'] = $orderform_policy_order_total;
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="td_numbig"><?php echo display_price($orderform_policy_shipping_total); ?></td>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="od_send_cost" value="<?php echo $orderform_policy_shipping_total; ?>" id="od_send_cost" class="frm_input" size="10"> 원
                                </td>
                            </tr>
                ...
                <div class="tbl_frm01">
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr class="!hidden">
                                <th scope="row">
                                    <label for="od_invoice">운송장번호</label>
                                </th>
                                <td>
