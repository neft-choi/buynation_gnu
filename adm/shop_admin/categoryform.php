...
// 카테고리 아이콘 메뉴 노출 조건
// $w가 빈 문자열이면 신규 등록, 값이 'u'면 수정
if ($w == '') {
    $is_first_category = ($ca_id == '');
} else {
    $is_first_category = (strlen($ca_id) == 2);
}
...
if ($w == 'u')
    $pg_anchor .= '<li><a href="#frm_etc" data-tab-target="frm_etc">기타설정</a></li>';
$pg_anchor .= '</ul>';
...
<form name="fcategoryform" action="./categoryformupdate.php" onsubmit="return fcategoryformcheck(this);" method="post"
            ...
            <table class="md:m-[-16px] m-0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <?php if ($w == "") { ?>
                                ...
                                <input type="text" name="ca_id" value="<?php echo $subid; ?>" id="ca_id" required
                                    class="required frm_input" size="<?php echo $sublen; ?>"
                                    maxlength="<?php echo $sublen; ?>">
                            <?php } else { ?>
                                ...
                                <a href="./categoryform.php?ca_id=<?php echo $ca_id; ?>&amp;<?php echo $qstr; ?>"
                                    class="btn btn_04">하위분류 추가</a>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="ca_name" value="<?php echo $ca['ca_name']; ?>" id="ca_name"
                                size="38" required class="required frm_input"></td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="ca_order" value="<?php echo $ca['ca_order']; ?>" id="ca_order"
                                class="frm_input" size="12">
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><?php if ($is_admin == 'super') { ?><label for="ca_mb_id"><?php } ?>관리
                                    회원아이디<?php if ($is_admin == 'super') { ?></label><?php } ?></th>
                        <td>
                            <?php if ($is_admin == 'super') { ?>
                                <input type="text" name="ca_mb_id"
                                    value="<?php echo get_sanitize_input($ca['ca_mb_id']); ?>" id="ca_mb_id"
                                    class="frm_input" maxlength="20">
                            <?php } else { ?>
                                <input type="hidden" name="ca_mb_id"
                                    value="<?php echo get_sanitize_input($ca['ca_mb_id']); ?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="ca_cert_use" value="1" id="ca_cert_use_yes" <?php if ($ca['ca_cert_use'])
                                                                                                        echo 'checked="checked"'; ?>>
                            <label for="ca_cert_use_yes">사용함</label>
                            <input type="radio" name="ca_cert_use" value="0" id="ca_cert_use_no" <?php if (!$ca['ca_cert_use'])
                                                                                                        echo 'checked="checked"'; ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="ca_adult_use" value="1" id="ca_adult_use_yes" <?php if ($ca['ca_adult_use'])
                                                                                                        echo 'checked="checked"'; ?>>
                            <label for="ca_adult_use_yes">사용함</label>
                            <input type="radio" name="ca_adult_use" value="0" id="ca_adult_use_no" <?php if (!$ca['ca_adult_use'])
                                                                                                        echo 'checked="checked"'; ?>>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="ca_img_width" value="<?php echo $ca['ca_img_width']; ?>"
                                id="ca_img_width" required class="required frm_input" size="5"> 픽셀
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="ca_img_height" value="<?php echo $ca['ca_img_height']; ?>"
                                id="ca_img_height" required class="required frm_input" size="5"> 픽셀
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="ca_list_mod" size="3" value="<?php echo $ca['ca_list_mod']; ?>"
                                id="ca_list_mod" required class="required frm_input"> 개
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="ca_list_row" value='<?php echo $ca['ca_list_row']; ?>'
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo help("쇼핑몰환경설정 &gt; 이미지(소) 넓이가 기본값으로 설정됩니다.\n" . G5_SHOP_URL . "/list.php에서 출력되는 이미지의 폭입니다."); ?>
                            <input type="text" name="ca_mobile_img_width"
                                value="<?php echo $ca['ca_mobile_img_width']; ?>" id="ca_mobile_img_width" required
                                class="required frm_input" size="5"> 픽셀
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <?php echo help("쇼핑몰환경설정 &gt; 이미지(소) 높이가 기본값으로 설정됩니다.\n" . G5_SHOP_URL . "/list.php에서 출력되는 이미지의 높이입니다."); ?>
                            <input type="text" name="ca_mobile_img_height"
                                value="<?php echo $ca['ca_mobile_img_height']; ?>" id="ca_mobile_img_height" required
                                class="required frm_input" size="5"> 픽셀
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <?php echo help("한 줄에 설정한 값만큼의 상품을 출력하지만 스킨에 따라 한 줄에 하나의 상품만 출력할 수도 있습니다."); ?>
                            <input type="text" name="ca_mobile_list_mod"
                                value='<?php echo $ca['ca_mobile_list_mod']; ?>' id="ca_mobile_list_mod" required
                                class="required frm_input" size="3"> 개
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <?php echo help("한 페이지에 출력할 이미지 줄 수를 설정합니다.\n한 페이지에서 표시하는 상품수는 (1줄당 이미지 수 x 줄 수) 입니다."); ?>
                            <input type="text" name="ca_mobile_list_row"
                                value='<?php echo $ca['ca_mobile_list_row']; ?>' id="ca_mobile_list_row" required
                                class="required frm_input" size="3"> 줄
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="ca_stock_qty" size="10" value="<?php echo $ca['ca_stock_qty']; ?>"
                                id="ca_stock_qty" class="frm_input"> 개
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="ca_sell_email" size="40"
                                value="<?php echo get_sanitize_input($ca['ca_sell_email']); ?>" id="ca_sell_email"
                                class="frm_input">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="checkbox" name="ca_use" <?php echo ($ca['ca_use']) ? "checked" : ""; ?>
                                value="1" id="ca_use">
                            예
                        </td>
                    </tr>
    ...
    <section id="anc_scatefrm_optional">
        ...
        <input type="hidden" name="ca_1_subj" value="<?php echo get_text($ca['ca_1_subj']); ?>">
        <input type="hidden" name="ca_1" value="<?php echo get_text($ca['ca_1']); ?>">
            ...
            <table class="md:m-[-16px] m-0">
                ...
                <tbody>
                    <?php if ($is_first_category) { ?>
                        <tr>
                            <th scope="row"><label for="ca_icon">카테고리 아이콘</label></th>
                            <td>
                                <?php echo help("상단 카테고리 메뉴에 사용할 아이콘 이미지를 선택합니다."); ?>

                                <?php if ($ca['ca_1']) { ?>
                                    <div class="mt-2 mb-4">
                                        <?php echo help("현재 아이콘"); ?>
                                        <img src="<?php echo htmlspecialchars($ca['ca_1'], ENT_QUOTES, 'UTF-8'); ?>"
                                            alt="<?php echo htmlspecialchars($ca['ca_name'], ENT_QUOTES, 'UTF-8'); ?> 아이콘"
                                            class="h-16 w-16 object-contain">
                                    </div>
                                <?php } ?>

                                <?php echo get_file_upload_field('ca_icon', 'ca_icon'); ?>
                            </td>
                        </tr>
                    <?php } ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="ca_include_head" value="<?php echo $ca['ca_include_head']; ?>"
                                id="ca_include_head" class="frm_input" size="60">
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="ca_include_tail" value="<?php echo $ca['ca_include_tail']; ?>"
                                id="ca_include_tail" class="frm_input" size="60">
                        </td>
                    </tr>
                    ...
                    <?php for ($i = 1; $i <= 10; $i++) { ?>
                        <tr>
                            ...
                            <td class="td_extra">
                                ...
                                <input type="text" name="ca_<?php echo $i ?>_subj" id="ca_<?php echo $i ?>_subj"
                                    value="<?php echo get_text($ca['ca_' . $i . '_subj']) ?>" class="frm_input">
                                <label for="ca_<?php echo $i ?>">여분필드 <?php echo $i ?> 값</label>
                                <input type="text" name="ca_<?php echo $i ?>" value="<?php echo get_text($ca['ca_' . $i]) ?>"
                                    id="ca_<?php echo $i ?>" class="frm_input">
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="checkbox" name="sub_category" value="1" id="sub_category"
                                    onclick="if (this.checked) if (confirm('이 분류에 속한 하위 분류의 속성을 똑같이 변경합니다.\n\n이 작업은 되돌릴 방법이 없습니다.\n\n그래도 변경하시겠습니까?')) return ; this.checked = false;">
                            </td>
                        </tr>
                    </tbody>
                </table>
