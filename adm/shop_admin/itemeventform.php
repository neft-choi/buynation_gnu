...
<form name="feventform" action="./itemeventformupdate.php" onsubmit="return feventform_check(this);" method="post"
        ...
        <table>
            ...
            <tbody>
                <?php if ($w == "u") { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo G5_SHOP_URL; ?>/event.php?ev_id=<?php echo $ev['ev_id']; ?>"
                                class="btn btn_04">이벤트바로가기</a>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="ev_img_width" value="<?php echo $ev['ev_img_width']; ?>"
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="ev_img_height" value="<?php echo $ev['ev_img_height']; ?>"
                            id="ev_img_height" required class="required frm_input" size="5"> 픽셀
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="ev_list_mod" value="<?php echo $ev['ev_list_mod']; ?>" id="ev_list_mod"
                            required class="required frm_input" size="3"> 개
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="ev_list_row" value="<?php echo $ev['ev_list_row']; ?>" id="ev_list_row"
                            required class="required frm_input" size="3"> 줄
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="ev_mobile_img_width">모바일 출력이미지 폭</label></th>
                    <td>
                        <input type="text" name="ev_mobile_img_width" value="<?php echo $ev['ev_mobile_img_width']; ?>"
                            id="ev_mobile_img_width" required class="required frm_input" size="5"> 픽셀
                    </td>
                </tr>
                <tr>
                    <th scope="row"><label for="ev_mobile_img_height">모바일 출력이미지 높이</label></th>
                    <td>
                        <input type="text" name="ev_mobile_img_height"
                            value="<?php echo $ev['ev_mobile_img_height']; ?>" id="ev_mobile_img_height" required
                ...
                <tr>
                    ...
                    <td>
                        <?php echo help("1행에 설정한 값만큼의 상품을 출력합니다. 스킨 설정에 따라 1행에 하나의 상품만 출력할 수도 있습니다."); ?>
                        <input type="text" name="ev_mobile_list_mod" value="<?php echo $ev['ev_mobile_list_mod']; ?>"
                ...
                <tr>
                    ...
                    <td>
                        <?php echo help("한 페이지에 출력할 이미지 줄 수를 설정합니다.\n한 페이지에 표시되는 상품수는 (1줄당 이미지 수 x 줄 수) 입니다."); ?>
                        <input type="text" name="ev_mobile_list_row" value="<?php echo $ev['ev_mobile_list_row']; ?>"
                            id="ev_mobile_list_row" required class="required frm_input" size="3"> 개
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="ev_subject" value="<?php echo htmlspecialchars2($ev['ev_subject']); ?>"
                            id="ev_subject" required class="required frm_input" size="60">
                        <input type="checkbox" name="ev_subject_strong" value="1" id="ev_subject_strong" <?php if ($ev['ev_subject_strong'])
                ...
                <tr>
                    <th scope="row"><label for="ev_add_commission_rate">수수료율(임시)</label></th>
                    <td>
                        <div class="flex items-center gap-3">
                            <span>기존 수수료 : 10%</span>
                            <span aria-hidden="true">+</span>

                            <label for="ev_add_commission_rate">추가 수수료 :</label>
                            <input type="number" name="ev_add_commission_rate" id="ev_add_commission_rate" min="0"
                                max="100" step="0.1" class="frm_input w-24">
                            <span>%</span>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <th scope="row">판매 가능 대상(임시)</th>
                    <td>
                        <div class="flex flex-col gap-2">
                            <label class="inline-flex items-center gap-2">
                                <input type="radio" name="ev_sale_target" value="all" checked>
                                <span>전체 도티</span>
                            </label>

                            <label class="inline-flex items-center gap-2">
                                <input type="radio" name="ev_sale_target" value="selected">
                                <span>지정 도티</span>
                            </label>
                        </div>

                        <div id="ev_selected_dotty_area" class="hidden mt-2">
                            <div class="flex items-center gap-2">
                                <select class="text-sm !px-2 !py-1">
                                    <option value="mb_id">아이디</option>
                                </select>
                                <input type="text"
                                    class="text-sm text-gray-900 border border-gray-300 rounded px-2 py-1">
                                <button type="button"
                                    class="text-sm border border-gray-400 rounded px-2 py-1">검색</button>
                            </div>

                            <div class="mt-2">
                                <label class="text-xs font-semibold">도티 검색(임시)</label>
                                <div class="border border-gray-600 rounded p-2 mt-1">
                                    <ul class="!space-y-2">
                                        <li class="flex items-center gap-2">
                                            <input type="checkbox">
                                            <p>인플루언서 김우빈</p>
                                            <button type="button"
                                                class="text-xs bg-blue-300 border border-gray-400 rounded px-1.5 py-0.5">추가</button>
                                        </li>
                                        <li class="flex items-center gap-2">
                                            <input type="checkbox">
                                            <p>인플루언서 한지민</p>
                            ...
                            <div class="mt-2">
                                <label class="text-xs font-semibold">등록된 도티(임시)</label>
                                <div class="border border-gray-600 rounded p-2 mt-1">
                                    <ul class="!space-y-2">
                                        <li class="flex items-center gap-2">
                                            <input type="checkbox">
                                            <p>인플루언서 김우빈</p>
                                            <button type="button"
                                                class="text-xs bg-red-300 border border-gray-400 rounded px-1.5 py-0.5">삭제</button>
                                        </li>
                                        <li class="flex items-center gap-2">
                                            <input type="checkbox">
                                            <p>인플루언서 한지민</p>
                                ...
                                if ($res_item) {
                                    for ($i = 0; $row = sql_fetch_array($res_item); $i++) {
                                        ...
                                        <li>
                                            ...
                                            <div class="list_item_btn"><button type="button"
                                                    class="del_item btn btn_04">삭제</button></div>
                                        </li>
                                        <?php
                                    }   // end for
                                }   // end if
...
<script>
    ...
    $(function () {
        const $saleTargetRadios = $("input[name='ev_sale_target']");
        const $selectedDottyArea = $("#ev_selected_dotty_area");

        function toggleSelectedDottyArea() {
            const selectedValue = $saleTargetRadios.filter(":checked").val();

            $selectedDottyArea.toggleClass(
                "hidden",
                selectedValue !== "selected"
            );
        }

        $saleTargetRadios.on("change", toggleSelectedDottyArea);

        toggleSelectedDottyArea();
    });
</script>
