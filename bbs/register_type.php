...
?>
<!-- 모바일 헤더 -->
<header class="flex pc:hidden items-center justify-between max-w-[460px] h-[var(--mobile-header-height)] mx-auto p-4">
    ...
    <button type="button" class="inline-flex items-center justify-center text-zinc-700" aria-label="닫기" onclick="window.location.href = '<?php echo G5_URL ?>'">
...
<div class="w-full max-w-[460px] mx-auto pt-12 pc:pt-16 p-4">
    ...
    <div class="space-y-8">
        <div class="text-center">
            ...
            <a href="http://172.30.1.93/adm/" class="inline-flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 23.999" aria-hidden="true">
                    <path d="M12,40a12,12,0,1,1,3.4-23.512A6.626,6.626,0,0,0,23.512,24.6,12,12,0,0,1,12,40Zm.138-15.448a3.586,3.586,0,1,0,3.586,3.586A3.59,3.59,0,0,0,12.138,24.552Z" transform="translate(0 -16)" fill="#ffdd56"></path>
                </svg>
        ...
        <form action="<?php echo G5_BBS_URL ?>/register.php" method="post" class="space-y-10">
            <div class="space-y-2">
                ...
                <label class="flex items-center justify-between p-4 border border-zinc-200 rounded cursor-pointer hover:bg-zinc-50 hover:border-zinc-400 has-[:checked]:border-gray-900 transition-all group">
                    <div class="flex items-center gap-3">
                        <input type="radio" name="mb_type" value="dots" checked class="w-5 h-5 appearance-none border border-zinc-300 rounded-full accent-white checked:border-[6px] checked:border-[var(--color-primary)]">
                ...
                <label class="flex items-center justify-between p-4 border border-zinc-200 rounded cursor-pointer hover:bg-zinc-50 hover:border-zinc-400 has-[:checked]:border-gray-900 transition-all group">
                    <div class="flex items-center gap-3">
                        <input type="radio" name="mb_type" value="donuts" class="w-5 h-5 appearance-none border border-zinc-300 rounded-full accent-white checked:border-[6px] checked:border-[var(--color-primary)]">
            ...
            <div class="space-y-3">
                ...
                <label class="flex items-center justify-between p-4 border border-zinc-200 rounded cursor-pointer hover:bg-zinc-50 hover:border-zinc-400 has-[:checked]:border-gray-900 transition-all group">
                    <div class="flex items-center gap-3">
                        <input type="radio" name="mb_type" value="supporter" class="w-5 h-5 appearance-none border border-zinc-300 rounded-full accent-white checked:border-[6px] checked:border-[var(--color-primary)]">
