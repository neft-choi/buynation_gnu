...
if ($w == "") {
    ...
    if (!isset($_POST['agree']) || !$_POST['agree']) {
        alert('도너츠 이용약관에 동의하셔야 회원가입 하실 수 있습니다.', G5_BBS_URL . '/register.php');
    }

    if (!isset($_POST['agree3']) || !$_POST['agree3']) {
        alert('전자금융서비스 이용약관에 동의하셔야 회원가입 하실 수 있습니다.', G5_BBS_URL . '/register.php');
    }

    if (!isset($_POST['agree2']) || !$_POST['agree2']) {
        alert('개인정보 수집 및 이용에 동의하셔야 회원가입 하실 수 있습니다.', G5_BBS_URL . '/register.php');
    }

    if (!isset($_POST['agree4']) || !$_POST['agree4']) {
        alert('만 14세 이상 여부를 확인하셔야 회원가입 하실 수 있습니다.', G5_BBS_URL . '/register.php');
    }
